...
class _LeaveStatusState extends State<LeaveStatusActivity> {
    ...
    return Scaffold(
      ...
      children: [
        ...
        Obx(() => controller.presentData.value
            ...
            : const Text(
                "There are not present any leave status.",
                style: TextStyle(
                  fontSize: 16,
    ...
    return Obx(() => controller.showProgressbar.value
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, int index) {
              GetLeaveStatusResult item =
                  controller.getLeaveStatusModel!.result![index];
  ...
  void openLeaveDetailBox(
      BuildContext context, GetLeaveStatusResult model) async {
    showDialog(
      context: context,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: Text(
                        model.leaveFromDate!.substring(0, 10),
                        style: MyTextStyle.titleStyle14bb,
                      ),
                    ),
                  ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: Text(
                        model.leaveToDate!.substring(0, 10),
                        style: MyTextStyle.titleStyle14bb,
                      ),
                    ),
                  ],
