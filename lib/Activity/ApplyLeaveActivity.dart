    ...
    return Scaffold(
      ...
      Column(
        ...
        children: <Widget>[
          ...
          Text(StringConstants.applyForLeave,style: MyTextStyle.titleStyle24bb,),
           Expanded(
             child: ListView(
               ...
               children: [
                 ...
                 Padding(
                   ...
                   child: Column(
                     ...
                     children: [
                       Obx(() => controller.dateLength.value>=2?Text(controller.dates[0].toString().substring(0,10)+" to "+controller.dates[controller.dateLength.value-1].toString().substring(0,10),style: MyTextStyle.titleStyle16bb,):
                       Text(controller.dates[0].toString().substring(0,10),style: MyTextStyle.titleStyle16bb,textAlign: TextAlign.start,)),
                       SizedBox(height: 5.px,),
                 ...
                 Container(
                   ...
                   child: CommonWidget.commonElevatedButton(onPressed: (){
                     if(controller.reasonController.text.isNotEmpty){
                       controller.changeProgressBar(true);
                       controller.callingAddAttendanceForm();
                     }else{
                       showToastMessage('Enter reason ...');
                     }

                   },text: StringConstants.applyForLeave,
                       buttonMargin: EdgeInsets.only(left: 20.px,right: 20.px,bottom: 5.px),
                       borderRadius: 30.px,
                       height: 60.px),
                 )),
                 SizedBox(height: 20.px,),
